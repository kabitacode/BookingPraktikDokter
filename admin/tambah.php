...
<body id="page-top">
    ...
    <div id="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form id="form" action="" method="POST">
                        <div class="mb-3">
                            ...
                            <input placeholder="Nama Pasien"  class="form-control" type="text" name="namaPasien" id="namaPasien">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date"  class="form-control" name="tglBooking" id="tglBooking">
                        </div>
        ...
        if (isset($_POST['submit'])) {
            ...
            $result = mysqli_query($conn, "INSERT INTO booking(namaPasien, alamat, noTelp, tglLahir, tglBooking) VALUES('$namaPasien', '$alamat', '$noTelp','$tglLahir', '$tglBooking')");
